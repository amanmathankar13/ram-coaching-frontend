...
import { initLoader }                from './api/api'
...
import { DPP, Classes, JEE, NEET, Resources, Results, Contact, Inquiry } from './pages/Pages'

// Connects axios loader to LoaderContext
function ApiLoaderBridge() {
  const { show, hide } = useLoader()
  useEffect(() => {
    initLoader(show, hide)
  }, [show, hide])
  return null
}
